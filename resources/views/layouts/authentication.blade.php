        ...
        <main class="bg-white">
            ...
            <div class="relative flex">
                        ...
                        <div class="flex-1">
                            <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
                                ...
                                <a class="block" href="{{ route('dashboard') }}">
                                   ...
                                   <span class="mx-auto text-lg font-semibold"> {{ config('app.name') }}</span>
                                </a>
                            </div>
                        </div>
                ...
                <div class="hidden md:block absolute top-0 bottom-0 right-0 md:w-1/2" aria-hidden="true">
                    <img class="object-cover object-center w-full h-full" src="{{ asset('images/login-image.jpg') }}" width="760" height="1024" alt="Authentication image" />
